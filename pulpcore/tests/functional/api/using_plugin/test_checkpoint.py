...
class TestCheckpointDistribution:
    ...
    @pytest.mark.parallel
    def test_no_trailing_slash_is_redirected(self, setup, http_get, distribution_base_url, checkpoint_url):
        ...
        # Test a root checkpoint distro with a specific timestamp
        pub_1_url = checkpoint_url(distribution, pubs[1].pulp_created)[:-1]
